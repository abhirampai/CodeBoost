...
const UserPrompt = ({ pasteCode, regenerateResponse }) => {
  ...
  return (
    <>
      {isModelLoading.value && <Spin tip="Loading model" fullscreen />}
      {contextHolder}
      <div className="flex flex-col items-center py-2 px-3 bg-gray-50 rounded-lg dark:bg-gray-700 space-y-2">
        <div className="w-full flex">
            ...
            <Tooltip title="Stop generation">
              ...
              >
                <svg
                  ...
                  strokeWidth="0"
                  viewBox="0 0 448 512"
                  className="text-slate-200 hover:scale-125 w-6 h-6 px-2"
                  height="1em"
                  width="1em"
          ...
          {!isEngineStreamLoading.value && (
            <Popconfirm
              ...
              okText="Sure"
            >
              <button className="inline-flex justify-center p-2 text-blue-600 rounded-full cursor-pointer hover:bg-red-600 hover:scale-105 hover:drop-shadow-xl">
                <svg
                  className="text-slate-200 hover:scale-125 h-6 w-6"
                  fillRule="evenodd"
        ...
        {isGeminiEngine.value && (
          <p className="font-bold dark:text-slate-200 text-gray-400">
